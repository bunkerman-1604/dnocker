...
echo "./13-networking-Self-service-networks.sh ${neutron} ${NEUTRON_DBPASS} ${NEUTRON_PASS} ${RABBIT_PASS} ${NOVA_PASS} ${CTL_HOST} ${PROVIDER_INTERFACE_NAME} ${OVERLAY_INTERFACE_IP_ADDRESS}"
./13-networking-Self-service-networks.sh ${neutron} ${NEUTRON_DBPASS} ${NEUTRON_PASS} ${RABBIT_PASS} ${NOVA_PASS} ${CTL_HOST} ${PROVIDER_INTERFACE_NAME} ${OVERLAY_INTERFACE_IP_ADDRESS}
